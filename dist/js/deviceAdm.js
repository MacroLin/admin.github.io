...
/******/ 	var hotCurrentHash = "e7e1db58516a00fbffce"; // eslint-disable-line no-unused-vars
					...
					icheckInit: function icheckInit() {
						...
						$(".checkbox-toggle").click(function () {
							...
							if (clicks) {
								...
								$(".fa", _this).removeClass("fa-check-square-o").addClass('fa-square-o');
							} else {
								//Check all checkboxes
								$(".mailbox-messages input[type='checkbox']").iCheck("check");
								$(".fa", _this).removeClass("fa-square-o").addClass('fa-check-square-o');
							}
...
var DeviceAdm = function () {
	function DeviceAdm() {
		_classCallCheck(this, DeviceAdm);
	}

	_createClass(DeviceAdm, [{
		key: 'init',
		value: function init() {
			$(function () {
				$('#table').DataTable({
